...
public sealed class ViewsGalleryViewModel : BaseGalleryViewModel
{
	public ViewsGalleryViewModel()
		: base(new[]
		{
			...
			SectionModel.Create<MultipleAvatarViewViewModel>("Multiple AvatarViews Page", Colors.Red, "AvatarView is a control for displaying an image or user's initials avatar. This page demonstrates available properties and samples."),
