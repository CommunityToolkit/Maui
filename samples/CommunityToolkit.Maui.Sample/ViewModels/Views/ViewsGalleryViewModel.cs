...
public sealed class ViewsGalleryViewModel : BaseGalleryViewModel
{
	public ViewsGalleryViewModel()
		: base(new[]
		{
			...
			SectionModel.Create<GravatarImageSourceViewModel>("GravatarImageSource page", Colors.Red, "GravatarImageSource supports using Gravatar. 'One avatar for everything, everywhere.'"),
