...
public sealed class ViewsGalleryViewModel : BaseGalleryViewModel
{
	public ViewsGalleryViewModel()
		: base(new[]
		{
			...
			SectionModel.Create<GravatarImageSourceViewModel>("GravatarImageSource page", Colors.Red, "GravatarImageSource provides an Image source to display a users Gravatar registered image via their email address."),
