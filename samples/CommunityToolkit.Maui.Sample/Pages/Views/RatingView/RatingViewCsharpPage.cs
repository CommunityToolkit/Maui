				...
				Children =
				{
					...
					new RatingView
						{
							...
							Style = new Style<RatingView>()
								...
								.Add(RatingView.FilledShapeColorProperty, Colors.Blue)
					...
					new RatingView
						...
						.Bind(RatingView.EmptyShapeColorProperty,
							...
							mode: BindingMode.OneWay)
						.Bind(RatingView.FilledShapeColorProperty,
