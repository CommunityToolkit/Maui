...
public class EdgeCaseTests : BaseBindablePropertyAttributeSourceGeneratorTest
{
	...
	[Fact]
	public async Task GenerateBindableProperty_PropertyIsSpecialEnum_GeneratesCorrectCode()
	{
		const string source =
			/* language=C#-test */
			//lang=csharp
		...
		const string expectedGenerated =
            ...
            public partial class {{defaultTestClassName}}
            {
                ...
                /// Backing BindableProperty for the <see cref = "@class"/> property.
                /// </summary>
                public static readonly global::Microsoft.Maui.Controls.BindableProperty InvoiceStatusProperty = global::Microsoft.Maui.Controls.BindableProperty.Create("InvoiceStatus", typeof(Status), typeof({{defaultTestNamespace}}.{{defaultTestClassName}}), null, Microsoft.Maui.Controls.BindingMode.OneWay, null, null, null, null, null);
                public partial Status InvoiceStatus { get => (Status)GetValue(classProperty); set => SetValue(classProperty, value); }
            }
            """;
