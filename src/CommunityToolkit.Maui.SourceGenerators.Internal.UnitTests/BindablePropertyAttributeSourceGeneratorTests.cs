	...
	public async Task GenerateBindableProperty_WithCustomPropertyName_GeneratesCorrectCode()
	{
		...
		const string expectedGenerated =
			...
			public partial class TestView
			{
			    ...
			    /// </summary>
			    public static readonly global::Microsoft.Maui.Controls.BindableProperty CustomNameProperty = global::Microsoft.Maui.Controls.BindableProperty.Create("CustomName", typeof(string), typeof(TestNamespace.TestView), null, Microsoft.Maui.Controls.BindingMode.OneWay, null, null, null, null, null);
			    public partial string CustomName { get => (string)GetValue(CustomNameProperty); set => SetValue(CustomNameProperty, value); }
			}
			""";
