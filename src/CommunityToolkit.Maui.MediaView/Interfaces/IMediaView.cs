...
/// <summary>
/// With MediaView you can play multimedia inside of your app.
/// </summary>
public interface IMediaView : IView
{
	/// <summary>
	/// The current state of the <see cref="MediaView"/>.
	/// </summary>
	MediaViewState CurrentState { get; }

	/// <summary>
	/// Triggers a <see cref="CurrentState"/> change.
	/// </summary>
	/// <param name="newState">The new state the <see cref="MediaView"/> transitioned to.</param>
	internal void CurrentStateChanged(MediaViewState newState);
