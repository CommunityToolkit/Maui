...
/// <summary>
/// The user-interface element that represents the <see cref="MediaView"/> on Android.
/// </summary>
public class MauiMediaView : CoordinatorLayout
{
	...
	public MauiMediaView(Context context, StyledPlayerView playerView) : base(context)
	{
