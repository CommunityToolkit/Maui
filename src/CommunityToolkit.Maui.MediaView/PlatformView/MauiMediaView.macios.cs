...
/// <summary>
/// The user-interface element that represents the <see cref="MediaView"/> on iOS and macOS.
/// </summary>
public class MauiMediaView : UIView
{
	/// <summary>
	...
	public MauiMediaView(AVPlayerViewController playerViewController)
	{
