...
public static class PopupExtensions
{
	...
	public static void SetLayout(this Popup mauiPopup, IPopup popup, IMauiContext? mauiContext)
	{
		...
		var hSign = popup.Content.FlowDirection == Microsoft.Maui.FlowDirection.RightToLeft ? -1 : 1;
		...
		if (IsTopLeft(verticalOptions, horizontalOptions))
		{
			...
			mauiPopup.HorizontalOffset = (popupParentFrame.Width - popupParentFrame.Width * hSign) / 2;
		...
		else if (IsTop(verticalOptions, horizontalOptions))
		{
			...
			mauiPopup.HorizontalOffset = (popupParentFrame.Width - contentSize.Width * hSign) / 2;
			mauiPopup.VerticalOffset = 0;
		}
		else if (IsTopRight(verticalOptions, horizontalOptions))
		{
			mauiPopup.DesiredPlacement = PopupPlacementMode.TopEdgeAlignedRight;
			mauiPopup.HorizontalOffset = (popupParentFrame.Width + popupParentFrame.Width * hSign) / 2 - contentSize.Width * hSign;
			mauiPopup.VerticalOffset = 0;
		}
