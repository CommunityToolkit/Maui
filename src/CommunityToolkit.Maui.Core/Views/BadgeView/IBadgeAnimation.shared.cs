...
{
	/// <summary>
	/// With the <see cref="OnAppearing(IView)"/> method you can influence the animation that is used when the <see cref="IBadgeView"/> appears.
	/// </summary>
	/// <param name="badgeView">The <see cref="BadgeView"/> instance on which the animation will be applied</param>
	/// <returns>An awaitable <see cref="Task"/></returns>
	Task OnAppearing(IView badgeView);
	...
	/// <param name="badgeView">The <see cref="BadgeView"/> instance on which the animation will be applied</param>
	/// <returns>An awaitable <see cref="Task"/></returns>
	Task OnDisappearing(IView badgeView);
}