...
public partial class ExpanderHandler : Microsoft.Maui.Handlers.ViewHandler<IExpander, View>
{
	/// <inheritdoc/>
	protected override View CreatePlatformView() => throw new NotSupportedException();
