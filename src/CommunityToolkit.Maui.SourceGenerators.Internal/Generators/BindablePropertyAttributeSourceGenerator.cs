...
public class BindablePropertyAttributeSourceGenerator : IIncrementalGenerator
{
	...
	public void Initialize(IncrementalGeneratorInitializationContext context)
	{
		...
		context.RegisterPostInitializationOutput(static ctx =>
		{
			...
			var attributeWithNormalizedLineEndings = bpAttribute.Replace("\r\n", "\n").Replace("\r", "\n");
			ctx.AddSource("BindablePropertyAttribute.g.cs", SourceText.From(attributeWithNormalizedLineEndings, Encoding.UTF8));
		});
