...
public class SelectAllTextBehavior : PlatformBehavior<InputView>
{
	...
	bool ApplyToUITextView(bool shouldApply)
	{
		...
		{
			Debug.WriteLine("WARNING: `SelectAllTextBehavior` does not support `Microsoft.Maui.Controls.Editor` on MacCatalyst. For more information, see https://github.com/CommunityToolkit/Maui/issues/432");
		}
