...
public static class AppBuilderExtensions
{
	...
	{
		builder.ConfigureImageSources(services => services.AddService<IGravatarImageSource>(svcs => new GravatarImageSourceService(svcs.CreateLogger<GravatarImageSourceService>())));
		return builder;
	}
}