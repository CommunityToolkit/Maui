...
public class IndexToArrayItemConverter : BaseConverter<int, object?, Array?>
{
	...
	public override object? ConvertFrom(int value, [NotNull] Array? parameter, CultureInfo? culture)
	{
	...
	public override int ConvertBackTo(object? value, [NotNull] Array? parameter, CultureInfo? culture)
	{
		ArgumentNullException.ThrowIfNull(parameter);
