...
public partial class Toast
{
	...
	private partial void ShowNative(CancellationToken token)
	{
		...
		NativeToast = Android.Widget.Toast.MakeText(Platform.CurrentActivity.Window?.DecorView.FindViewById(Android.Resource.Id.Content)?.RootView?.Context, styledText, GetToastLength(Duration))
