...
static class NamespaceSymbolExtensions
{
	...
	/// <returns>A text string containing all Generic Type Constraints for <see cref="INamedTypeSymbol"/>, eg "where T : ITextStyle, notnull". Returns <see cref="string.Empty"/> if no generic type constraints found</returns>
