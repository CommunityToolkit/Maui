...
public class DefaultPopupOptionsSettingsTests : BaseHandlerTest
{
	...
	[Fact]
	public void PopupBorder_SetPopupOptionsDefaultsNotCalled_UsesPopupOptionsDefaults()
	{
		// Arrange
	...
	[Fact]
	public void PopupBorder_SetPopupOptionsNotCalled_PopupOptionsEmptyUsed_UsesPopupOptionsDefaults()
	{
		// Arrange
	...
	[Fact]
	public void PopupBorder_SetPopupDefaultsCalled_UsesDefaultPopupOptionsSettings()
	{
		// Arrange
	...
	[Fact]
	public void PopupBorder_SetPopupDefaultsCalled_PopupOptionsOverridden_UsesProvidedPopupOptionsSettings()
	{
		// Arrange
		var hasOnTappingOutsideOfPopupExecuted = false;
