...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	[Fact]
	public void WithRed_Double_RedGreaterThan1ShouldThrowArgumentOutOfRangeException()
	{
		Color c = new();
	...
	[Fact]
	public void WithRed_Double_RedNegativeShouldThrowArgumentOutOfRangeException()
	{
		Color c = new();
		var red = -Random.Shared.NextDouble();
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	[Fact]
	public void WithGreen_Double_GreenGreaterThan1ShouldThrowArgumentOutOfRangeException()
	{
		Color c = new();
	...
	[Fact]
	public void WithGreen_Double_GreenNegativeShouldThrowArgumentOutOfRangeException()
	{
		Color c = new();
		var green = -Random.Shared.NextDouble();
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	[Fact]
	public void WithBlue_Double_BlueGreaterThan1ShouldThrowArgumentOutOfRangeException()
	{
		Color c = new();
