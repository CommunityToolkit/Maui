...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
	...
	public void ShowPopupAsync_WithViewType_SetsCorrectDefaults()
	{
		...
		// Assert
		Assert.Equal(DefaultPopupSettings.PopupDefaults.BackgroundColor, autogeneratedPopup.BackgroundColor);
		Assert.Equal(DefaultPopupSettings.PopupDefaults.HorizontalOptions, autogeneratedPopup.HorizontalOptions);
		Assert.Equal(DefaultPopupSettings.PopupDefaults.VerticalOptions, autogeneratedPopup.VerticalOptions);
		Assert.Equal(DefaultPopupSettings.PopupDefaults.Padding, autogeneratedPopup.Padding);
	}
