...
public class ColorToRgbStringConverterTests : BaseConverterTest<ColorToRgbStringConverter>
{
	public static readonly TheoryData<float, float, float, float, string> ValidInputData = new()
	{
		...
		{
			0.5f, 0, 0, 1, "RGB(128,0,0)"
		},
		{
			0.5f, 0, 0, 0, "RGB(128,0,0)"
		},
		{
			0, 0.5f, 0, 1, "RGB(0,128,0)"
		},
		{
			0, 0.5f, 0, 0, "RGB(0,128,0)"
		},
		{
			0, 0, 0.5f, 1, "RGB(0,0,128)"
		},
		{
			0, 0, 0.5f, 0, "RGB(0,0,128)"
		},
		{
			0.5f, 0.5f, 0.5f, 1, "RGB(128,128,128)"
		},
		{
			0.5f, 0.5f, 0.5f, 0, "RGB(128,128,128)"
		},
		{
			0.25f, 0.25f, 0.25f, 1, "RGB(64,64,64)"
		},
		{
			0.25f, 0.25f, 0.25f, 0, "RGB(64,64,64)"
		},
		{
			0.25f, 0.25f, 1, 1, "RGB(64,64,255)"
		},
		{
			0.25f, 0.25f, 1, 0, "RGB(64,64,255)"
		},
		{
			0.25f, 1, 0.25f, 1, "RGB(64,255,64)"
		},
		{
			0.25f, 1, 0.25f, 0, "RGB(64,255,64)"
		},
		{
			0.75f, 1, 0.25f, 1, "RGB(191,255,64)"
		},
		{
			0.75f, 1, 0.25f, 0, "RGB(191,255,64)"
		},
		{
			0.75f, 0, 1, 1, "RGB(191,0,255)"
		},
		{
			0.75f, 0, 1, 0, "RGB(191,0,255)"
		},
	};
