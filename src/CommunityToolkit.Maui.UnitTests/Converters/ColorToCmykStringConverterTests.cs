...
public class ColorToCmykStringConverterTests : BaseOneWayConverterTest<ColorToCmykStringConverter>
{
	public static readonly TheoryData<float, float, float, float, string> ValidInputData = new()
	{
		...
		{
			0.5f, 0, 0, 1, "CMYK(0%,100%,100%,50%)"
		},
		{
			0.5f, 0, 0, 0, "CMYK(0%,100%,100%,50%)"
		},
		{
			0, 0.5f, 0, 1, "CMYK(100%,0%,100%,50%)"
		},
		{
			0, 0.5f, 0, 0, "CMYK(100%,0%,100%,50%)"
		},
		{
			0, 0, 0.5f, 1, "CMYK(100%,100%,0%,50%)"
		},
		{
			0, 0, 0.5f, 0, "CMYK(100%,100%,0%,50%)"
		},
		{
			0.5f, 0.5f, 0.5f, 1, "CMYK(0%,0%,0%,50%)"
		},
		{
			0.5f, 0.5f, 0.5f, 0, "CMYK(0%,0%,0%,50%)"
		},
		{
			0.25f, 0.25f, 0.25f, 1, "CMYK(0%,0%,0%,75%)"
		},
		{
			0.25f, 0.25f, 0.25f, 0, "CMYK(0%,0%,0%,75%)"
		},
		{
			0.25f, 0.25f, 1, 1, "CMYK(75%,75%,0%,0%)"
		},
		{
			0.25f, 0.25f, 1, 0, "CMYK(75%,75%,0%,0%)"
		},
		{
			0.25f, 1, 0.25f, 1, "CMYK(75%,0%,75%,0%)"
		},
		{
			0.25f, 1, 0.25f, 0, "CMYK(75%,0%,75%,0%)"
		},
		{
			0.75f, 1, 0.25f, 1, "CMYK(25%,0%,75%,0%)"
		},
		{
			0.75f, 1, 0.25f, 0, "CMYK(25%,0%,75%,0%)"
		},
		{
			0.75f, 0, 1, 1, "CMYK(25%,100%,0%,0%)"
		},
		{
			0.75f, 0, 1, 0, "CMYK(25%,100%,0%,0%)"
		},
	};
