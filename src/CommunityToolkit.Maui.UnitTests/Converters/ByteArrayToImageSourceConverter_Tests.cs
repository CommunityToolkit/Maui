...
public class ByteArrayToImageSourceConverter_Tests : BaseTest
{
	...
	public async Task ByteArrayToImageSourceConverter()
	{
		...
		var convertFromResult = (StreamImageSource)byteArrayToImageSourceConverter.ConvertFrom(byteArray, CultureInfo.CurrentCulture);
	...
	public void ConvertImageSourceBackToByteArray()
	{
		...
		var convertBackToResult = byteArrayToImageSourceConverter.ConvertBackTo((StreamImageSource)ImageSource.FromStream(() => new MemoryStream(byteArray)), CultureInfo.CurrentCulture);
	...
	public void ConvertEmptyImageSourceBackToByteArray()
	{
		...
		var convertBackToResult = byteArrayToImageSourceConverter.ConvertBackTo(expectedValue, CultureInfo.CurrentCulture);
	...
	public void ConvertNullImageSourceBackToByteArray()
	{
		...
		var convertBackToResult = byteArrayToImageSourceConverter.ConvertBackTo(nullStream, CultureInfo.CurrentCulture);
	...
	public void ConvertingBackNullResultsInNull()
	{
		...
		var convertBackToResult = byteArrayToImageSourceConverter.ConvertBackTo(null, CultureInfo.CurrentCulture);
