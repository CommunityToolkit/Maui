...
public class ColorToCmykaStringConverterTests : BaseOneWayConverterTest<ColorToCmykaStringConverter>
{
	public static readonly TheoryData<float, float, float, float, string> ValidInputData = new()
	{
		...
		{
			0, 0, 0, -0.5f, "CMYKA(0%,0%,0%,100%,0)"
		},
		{
			0, 0, 0, 0, "CMYKA(0%,0%,0%,100%,0)"
		},
		{
			0, 0, 0, 0.5f, "CMYKA(0%,0%,0%,100%,0.5)"
		},
		{
		...
		{
			0.5f, 0, 0, 1, "CMYKA(0%,100%,100%,50%,1)"
		},
		{
			0.5f, 0, 0, 0, "CMYKA(0%,100%,100%,50%,0)"
		},
		{
			0, 0.5f, 0, 1, "CMYKA(100%,0%,100%,50%,1)"
		},
		{
			0, 0.5f, 0, 0, "CMYKA(100%,0%,100%,50%,0)"
		},
		{
			0, 0, 0.5f, 1, "CMYKA(100%,100%,0%,50%,1)"
		},
		{
			0, 0, 0.5f, 0, "CMYKA(100%,100%,0%,50%,0)"
		},
		{
			0.5f, 0.5f, 0.5f, 1, "CMYKA(0%,0%,0%,50%,1)"
		},
		{
			0.5f, 0.5f, 0.5f, 0, "CMYKA(0%,0%,0%,50%,0)"
		},
		{
			0.25f, 0.25f, 0.25f, 1, "CMYKA(0%,0%,0%,75%,1)"
		},
		{
			0.25f, 0.25f, 0.25f, 0, "CMYKA(0%,0%,0%,75%,0)"
		},
		{
			0.25f, 0.25f, 1, 1, "CMYKA(75%,75%,0%,0%,1)"
		},
		{
			0.25f, 0.25f, 1, 0, "CMYKA(75%,75%,0%,0%,0)"
		},
		{
			0.25f, 1, 0.25f, 1, "CMYKA(75%,0%,75%,0%,1)"
		},
		{
			0.25f, 1, 0.25f, 0, "CMYKA(75%,0%,75%,0%,0)"
		},
		{
			0.75f, 1, 0.25f, 1, "CMYKA(25%,0%,75%,0%,1)"
		},
		{
			0.75f, 1, 0.25f, 0, "CMYKA(25%,0%,75%,0%,0)"
		},
		{
			0.75f, 0, 1, 1, "CMYKA(25%,100%,0%,0%,1)"
		},
		{
			0.75f, 0, 1, 0, "CMYKA(25%,100%,0%,0%,0)"
		},
	};
