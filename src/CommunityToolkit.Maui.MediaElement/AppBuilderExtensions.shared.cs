...
public static class AppBuilderExtensions
{
	...
	/// <param name="isAndroidForegroundServiceEnabled">Enables Android Foreground Service for <see cref="MediaElement"/>.
	/// When <c>true</c>, the following permissions are automatically added to the Android Manifest by CommunityToolkit.Maui.MediaElement: FOREGROUND_SERVICE, MEDIA_CONTENT_CONTROL, POST_NOTIFICATION, FOREGROUND_SERVICE_MEDIA_PLAYBACK
	/// </param>
	...
	public static MauiAppBuilder UseMauiCommunityToolkitMediaElement(this MauiAppBuilder builder, bool isAndroidForegroundServiceEnabled, Action<MediaElementOptions>? options = null)
	{
