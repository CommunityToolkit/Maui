...
public static class AppBuilderExtensions
{
	...
	/// <param name="mediaElementOptions"><see cref="MediaElementOptions"/> default constructor options for <see cref="MediaElement"/>.</param>
	...
	/// </summary>
	/// <param name="builder"><see cref="MauiAppBuilder"/> generated by <see cref="MauiApp"/>.</param>
	/// <param name="mediaElementOptionsAction"><see cref="MediaElementOptions"/> default constructor options for <see cref="MediaElement"/>.</param>
	/// <returns><see cref="MauiAppBuilder"/> initialized for <see cref="MediaElement"/>.</returns>
