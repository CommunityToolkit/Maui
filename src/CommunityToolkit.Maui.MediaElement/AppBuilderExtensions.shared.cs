...
public static class AppBuilderExtensions
{
	...
	/// <param name="mediaElementOptionsAction"><see cref="MediaElementOptions"/> Action that will configure the default MediaElementOptions for constructor of <see cref="MediaElement"/>.</param>
